...
export const shadowLight: Record<'sm' | 'md' | 'lg', ViewStyle> = {
  sm: { shadowColor: shadowWarm, shadowOpacity: 0.14, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  md: { shadowColor: shadowWarm, shadowOpacity: 0.20, shadowRadius: 16, shadowOffset: { width: 0, height: 10 }, elevation: 6 },
  lg: { shadowColor: shadowWarm, shadowOpacity: 0.28, shadowRadius: 30, shadowOffset: { width: 0, height: 18 }, elevation: 12 },
}
...
export const shadowNoneSet: Record<'sm' | 'md' | 'lg', ViewStyle> = {
  sm: shadowNone, md: shadowNone, lg: shadowNone,
}
