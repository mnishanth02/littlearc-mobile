...
export const lightTheme = {
  ...
  colors: {
    ...
    onPrimary: p.white,
    accent: p.violet[700],
    primaryTint: hexA(p.violet[500], 0.12),

    success: p.mint[500],
    successText: p.mint[700],
    successTint: hexA(p.mint[500], 0.16),
    warning: p.sun[500],
    warningText: p.sun[700],
    warningTint: hexA(p.sun[500], 0.18),
    danger: p.danger[500],
    dangerText: p.danger[700],
    dangerTint: hexA(p.danger[500], 0.12),
    onDanger: p.white,
    info: p.blue[500],
    infoText: p.blue[700],
    infoTint: hexA(p.blue[500], 0.15),
